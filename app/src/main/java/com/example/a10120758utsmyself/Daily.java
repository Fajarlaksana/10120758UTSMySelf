...
public class Daily extends AppCompatActivity {
    ...
    String[] subjects = {
            "Wake Up", "Take a Bath", "Have a Breakfast", "Studying", "Work as Barista", "Watching an Movie",
            "Exercising", "VC with GF","Sleep"
    };
    int[] subjectImage ={
    ...
    int[] subjectImageFriend ={
            R.drawable.pepeh1,R.drawable.pepeh2,
            R.drawable.pepeh3
    };
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerViewAdapterFriend = new com.example.a10120758utsmyself.AdapterRecyclerViewFriend(subjectsName, subjectImageFriend,contextFriend );
